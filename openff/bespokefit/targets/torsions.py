        ...
        if self.fragmentation:
            ...
            for fragment in fragments:
                ...
                for fragment_torsion in torsions:
                    if fragment.fragment_molecule != fragment.parent_molecule:
                        parent_torsion = [
                            fragment.fragment_parent_mapping[i]
                            for i in fragment_torsion
                        ]
