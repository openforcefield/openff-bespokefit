...
Here we have specified that we wish to start the fit from the general OpenFF 2.2.0 RC1 (Sage) force field, augmenting
...
factory = BespokeWorkflowFactory(
    ...
    # parameters.
    initial_force_field="openff-2.2.0-rc1.offxml",
...
The default factory will produce [workflows](workflow_chapter) that augment the OpenFF 2.2.0 RC1 force field
